...
public final class Constants {
    ...
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 32; // FIXME Set back left steer encoder ID
    ...
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 42; // FIXME Set back right steer encoder ID
